...
exports['default'] = function () {
    var branchPromise = (0, _gitBranch2['default'])();
    ...
    return {
        ...
        reportTaskDone: function reportTaskDone(endTime, passed, warnings) {
            ...
            branchPromise.then(function () {
                ...
                return _this2.slack.addMessage(err);
            })['finally'](function () {
                _this2.slack.addMessage(footer);
                _this2.slack.sendTestReport(_this2.testCount - passed);
            });
        }
    };
};
